...
export default async function EditRinjaniPage({ params }: Props) {
  ...
  return (
    <AdminSidebar>
      <ActivityForm initialData={serialized} category="rinjani-tracking" categoryLabel="Rinjani Tracking" />
    </AdminSidebar>
  );
}
