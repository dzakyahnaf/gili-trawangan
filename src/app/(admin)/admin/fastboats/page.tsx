    ...
    <AdminSidebar>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button className="px-4 py-2 rounded-xl bg-ocean-500 text-white text-sm font-semibold">+ Tambah Operator</button>
        </div>
        {allFastBoats.map((b) => (
          <div key={b.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button className="text-ocean-600 hover:underline text-sm font-semibold">Edit</button>
            </div>
