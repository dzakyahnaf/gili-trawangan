    ...
    <AdminSidebar>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button className="px-4 py-2 rounded-xl bg-gili-500 text-white text-sm font-semibold">+ Tambah Speedboat</button>
        </div>
            ...
            <tbody>
              {allSpeedboats.map((s) => (
                <tr key={s.id} className="border-b border-gray-50 hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 font-semibold text-gili-600">{formatRupiah(s.price)}</td>
