    ...
    <AdminSidebar>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button className="px-4 py-2 rounded-xl bg-gili-500 text-white text-sm font-semibold">+ Tambah</button>
        </div>
          ...
          {allTestimonials.map((t) => (
            <div key={t.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button className="text-gili-600 hover:underline text-xs font-semibold">Edit</button>
              </div>
