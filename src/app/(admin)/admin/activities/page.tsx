    ...
    <AdminSidebar>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button className="px-4 py-2 rounded-xl bg-gili-500 text-white text-sm font-semibold hover:bg-gili-600 transition-colors">+ Tambah Aktivitas</button>
        </div>
            ...
            <tbody>
              {allActivities.map((a) => (
                <tr key={a.id} className="border-b border-gray-50 hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 font-semibold text-gili-600">{formatRupiah(a.price)}</td>
                  ...
                  <td className="px-4 py-3"><button className="text-gili-600 hover:underline text-xs font-semibold">Edit</button></td>
                </tr>
              ))}
            </tbody>
          </table>
