...
export default async function EditPrivateSpeedboatCarPage({ params }: Props) {
  ...
  return (
    <AdminSidebar>
      <ActivityForm initialData={serialized} category="private-speed-boat-and-car" categoryLabel="Speedboat & Car" />
    </AdminSidebar>
  );
}
