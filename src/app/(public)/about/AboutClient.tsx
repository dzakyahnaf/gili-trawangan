...
export default function AboutClient({ aboutTextId, aboutTextEn }: Props) {
  const { t, locale } = useLang();

  const activeAboutText = locale === "en" 
    ? (aboutTextEn || "We are a trusted travel service provider in Gili Trawangan, Lombok...")
    : (aboutTextId || "Kami adalah penyedia jasa wisata terpercaya di Gili Trawangan, Lombok...");
    ...
    <div className="pt-16 lg:pt-20 pb-20">
      ...
      <div className="max-w-4xl mx-auto px-4 space-y-16">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-600 leading-relaxed max-w-2xl mx-auto whitespace-pre-wrap">
            {activeAboutText}
          </p>
        </div>
