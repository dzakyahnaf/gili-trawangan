  ...
  return (
    <div className="pt-16 lg:pt-20 pb-20">
      <div className="relative h-72 lg:h-96">
        <Image src={act.coverImage} alt={act.name} fill sizes="100vw" className="object-cover" priority />
      ...
      <div className="max-w-7xl mx-auto px-4 mt-10 grid lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">{locale === "en" ? "Schedule" : "Jadwal"}</h2>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24 bg-white rounded-2xl shadow-xl border border-gray-100 p-6 space-y-6">
            <div>
              <p className="text-sm text-gray-400">{locale === "en" ? "Price" : "Harga"}</p>
              <p className="text-3xl font-bold text-gili-600">{formatCurrency(act.price, locale)}</p>
