            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="text-xs text-gray-400 uppercase font-bold tracking-wider">Instagram</p>
                    <a href="https://www.instagram.com/rhtourandtravel3003/" target="_blank" rel="noopener noreferrer" className="text-gray-900 font-semibold hover:text-pink-600 transition-colors">@rhtourandtravel3003</a>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-10 h-10 rounded-xl bg-gili-50 flex items-center justify-center shrink-0">
