...
const SNORKELING_DATA: Record<string, any> = {
  ...
  "private-snorkeling-6-hours": {
    ...
    en: {
      ...
      description: "The ultimate snorkeling day. 6 full hours with your own private boat. Explore hidden reefs, stop at any of the islands for lunch, and enjoy the beautiful Gili waters.",
      highlights: ["All 3 Gili Islands", "Hidden Reef Spots", "Island Hopping", "6 Hours Freedom"],
      itinerary: [
    ...
    id: {
      price: "Rp 2.000.000",
      title: "Snorkeling Privat Selama 6 Jam",
      description: "Hari snorkeling terbaik. 6 jam penuh dengan kapal privat Anda sendiri. Jelajahi terumbu karang tersembunyi, berhenti di pulau mana pun untuk makan siang, dan nikmati indahnya perairan Gili.",
      highlights: ["Semua 3 Kepulauan Gili", "Spot Karang Tersembunyi", "Island Hopping", "Kebebasan Penuh 6 Jam"],
      itinerary: [
...
// Aliasing the 8 hours key to the 6 hours data to ensure old bookmarks do not break
SNORKELING_DATA["private-snorkeling-8-hours"] = SNORKELING_DATA["private-snorkeling-6-hours"];
