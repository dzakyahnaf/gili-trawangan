      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <div>
              <span className={`font-bold text-lg leading-none ${scrolled ? "text-gray-900" : "text-white"}`}>
                RH Tour
              </span>
              <span className={`block text-[10px] leading-none ${scrolled ? "text-ocean-600" : "text-ocean-200"}`}>
                & Travel
              </span>
            </div>
          </Link>
